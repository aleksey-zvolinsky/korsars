...
$lang['tz']['3'] = 'GMT + 3 (московское время,летнее киевское время)';
$lang['tz']['3.5'] = 'GMT + 3:30';
...
$lang['Session_invalid'] = 'Ламаная сессия. Пожалуйста переотправьте форму.';

$lang['Watched_Topics'] = 'Наблюдаемые темы';
$lang['No_Watched_Topics'] = 'Вы не наблюдаете за темами';
$lang['Watched_Topics_Started'] = 'Наблюдение начато';
$lang['Watched_Topics_Stop'] = 'Наблюдение окончено';
$lang['Check_All'] = 'Выбрать все';
$lang['UnCheck_All'] = 'Убрать все';
...
$lang['Hidden'] = 'Hidden';
$lang['is_online'] = '%s в онлайне';
$lang['is_offline'] = '%s в оффлайне';
$lang['is_hidden'] = '%s спрятан';
$lang['Online_status'] = 'Статус';
// End add - Online/Offline/Hidden Mod


// Start add - Global announcement MOD
$lang['Topic_global_announcement']='<b>Всеобщее уведомление:</b>';
$lang['Post_global_announcement'] = 'Всеобщее уведомление';
// End add - Global announcement MOD


// Log actions MOD Start
$lang['Close_window'] = 'Закройте окно';
$lang['Rules_title'] = 'Действие : %s';
$lang['Locking_topic'] = 'Закрытие темы';
$lang['Unlocking_topic'] = 'Открытие темы';
$lang['Spliting_topic'] = 'Разделение темы';
$lang['Moving_topic'] = 'Перемещение темы';
$lang['Deleting_topic'] = 'Удаление темы';
$lang['Editing_topic'] = 'Редактирование темы';
$lang['Lock_Explication'] = 'Когда модератор/администратор закроет тему, обычные пользователи не смогут оставлять ответы в этой теме. Но модераторы/администраторы могут оставлять ответы в теме или редактировать сообщения.';
$lang['Unlock_Explication'] = 'Модератор/администратор может открыть тему, которая была закрыта. Это позволит простым пользователям продолжить обсуждение в теме.';
$lang['Split_Explication'] = 'Разделение темы, которая имеет много страниц, дает Вам возможность держать темы более организованными.';
$lang['Move_Explication'] = 'Если Вы хотите переместить тему, то Вы можете отправить тему, которая находится в форуме A, на форум B. Вы можете также оставлять ссылку на перемещенную тему из форума A.';
$lang['Delete_Explication'] = 'Если модератор/администратор удаляет тему, то она больше не будет присутствовать в форуме, и никто не сможет восстановить ее.  <br /><b>Будте осторожны с этой функцией</b>';
$lang['Edit_Explication'] = 'Редактируя пост, Администратор или модератор могут изменить то, что пользователь написал в посте.';
$lang['No_action_specified'] = 'Нет никакого указанного действия';
// Log actions MOD End

// Start add - Bin Mod
$lang['Move_bin'] = 'Отправить в корзину';
$lang['Topics_Moved_bin'] = 'Отправлено в корзину.';
$lang['Bin_disabled'] = 'Корзина отключена';
