...
h1,h2		{ font-family: "Trebuchet MS", Verdana, Arial, Helvetica, sans-serif; font-size : 18px; font-weight : normal; text-decoration : none; line-height : 120%; color : #000000;}
...
td.rowpic {
		...
		background-image: url(../templates/Diddle/images/{T_TH_CLASS3});
...
th	{
	...
	background-image: url(../templates/Diddle/images/{T_TH_CLASS2});
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(../templates/Diddle/images/{T_TH_CLASS1});
...
*/
.helpline { background-color: #E7FBD6; border: 1px dotted #000000; }

/* Import the fancy styles for IE only (NS4.x doesn't use the @import function) */
@import url("../templates/Diddle/formIE.css"); 
-->
</style>
