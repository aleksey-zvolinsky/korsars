...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	<tr>
		<th class="thCornerL" width="62%">{L_ABQ_FONT}</th>
		<th class="thTop" width="38%">{L_FILELOCATION}</th>
	</tr>
	<tr> 
		<td class="row1"><span class="gen">{L_UPLOAD_FONT_FILE}:</span><span class="gensmall">{L_UPLOAD_FONT_FILE_EXPLAIN}</span></td>
		<td class="row2"><input type="hidden" name="MAX_FILE_SIZE" value="{S_FONT_MAXSIZE}" /><input type="file" name="fontfile" class="post" style="width:200px" /></td>
	</tr>
