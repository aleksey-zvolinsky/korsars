...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	...
	<tr>
		<td class="row1"><span class="gen">{IMAGE}</span></td>
	...
	<!-- BEGIN switch_delete -->
	<tr>
		<td class="row1"><span class="gen">{IMAGE}<input type="hidden" name="name" value="{IMAGE}" /></span></td>
		<td class="row1"><input type="hidden" value="delete" name="mode" /><input type="hidden" name="id" value="{S_IMAGE_ID}" /><input name="submit" type="submit" value="{L_DELETE}" class="mainoption" /></td>
	</tr>
	<tr>
