...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	<tr>
		<th class="thCornerL" width="25%">{L_ABQ_FONT}</th>
		<th class="thTop" width="75%" colspan="2">{L_EXAMPLE}</th>
	</tr>
	<!-- BEGIN switch_gd_ft_not_installed -->
	<tr>
		<td class="row1" colspan="3" align="center"><span class="gen">{L_GD_FT_NOT_INSTALLED}</span></td>
	</tr>
	<!-- END switch_gd_ft_not_installed -->
	<!-- BEGIN switch_unknown_font -->
	<tr>
		<td class="row1" colspan="3" align="center"><span class="gen">{L_ABQ_UNKNOWN_FONT}</span></td>
	</tr>
	<!-- END switch_unknown_font -->
	<!-- BEGIN switch_example -->
	<tr>
		<td class="row1" width="25%"><span class="gen">{FONT}</span></td>
		<td class="row1" width="25%">{L_NOTE}<br />{LINE1}<br />{LINE2}<br />{LINE3}<br />{LINE4}</td>
		<td class="row1" width="50%">{EXAMPLE}</td>
	</tr>
	<!-- END switch_example -->
</table>
<br clear="all" />
