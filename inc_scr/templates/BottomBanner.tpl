...
<!--noindex-->
	...
	{if $smarty.server.REQUEST_URI=='/' or $smarty.server.REQUEST_URI==''}
		...
		<!--
			...
			st24Src+='dwCVhobXLSxECVGLNiK7b5bxfZrgSkd6suhVuVARz0P.37/l=11';
	...
	{else}
		...
		<!--
			...
			var st24Src='http://ua5.hit.stat24.com/_'+st24Date;
			st24Src+='/script.js?id=';
			st24Src+='zaA7Au9meKGJdtqSW6cupLdMHZKwSIdMHDoV2qWUz4v.t7/l=11';
			var st24Tg='<'+'scr'+'ipt type="text/javascript" src="';
			document.writeln(st24Tg+st24Src+'"></'+'scr'+'ipt>');
			//-->
		</script>
...
<!--/ SpyLOG -->
	...
	<!--bigmir)net TOP 100-->
		...
		<script type="text/javascript" language="javascript"><!--
		bmN=navigator,bmD=document,bmD.cookie='b=b',i=0,bs=[],bm={o:1,v:172915,s:172915,t:0,c:bmD.cookie?1:0,n:Math.round((Math.random()* 1000000)),w:0};
